...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Name" required="" value="<?php echo e(old('name')); ?>" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email address here" required autocomplete="email">
                ...
                <div>
                    ...
                    <div class="d-md-flex justify-content-between mt-4">
                        <div class="mb-2 mb-md-0">
                            <a href="<?php echo e(route('login')); ?>" class="fs-5"><?php echo e(__('Already member? Login')); ?></a>
                        </div>
                        <div>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-inherit fs-5">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/auth/register.blade.php ENDPATH**/ ?>