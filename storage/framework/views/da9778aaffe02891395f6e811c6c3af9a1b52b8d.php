        ...
        <table id="info" style="width:100%;margin-bottom:7px;">
            <tr>
                ...
                <td style="border-left:none;position:relative;">
                    <div style="padding-left:150px;margin-bottom:8px;">Date: <?php echo e($vehicle['date']); ?></div>
        ...
        <table class="job-details">
            ...
            <tr>
                ...
                <td style="position:relative;text-align:left;padding:3px;">
                    <span style="padding-left:3px;"><?php if(isset($vehicle['is_logbook']) && $vehicle['is_logbook'] == 1): ?> Carryout minor engine service, Log book. <?php else: ?> Carryout minor engine service. <?php endif; ?></span>
                </td>
            ...
            <?php $__currentLoopData = $concerns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $concern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="position:relative;height:16px;padding:3px;"><span style="padding-left:3px;"><?php echo e(ucfirst($concern)); ?></span></td>
                    <td style="position:relative;width:100px;height:16px;"></td>
                </tr>
...
</html><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/jobcards/minor_service.blade.php ENDPATH**/ ?>