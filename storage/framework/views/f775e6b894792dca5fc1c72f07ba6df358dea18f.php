...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($customer->name ?? old('name')); ?>" placeholder="<?php echo e(__('Enter customer name')); ?>">
...
<div class="mb-3 col-md-4 col-4">
    ...
    <input type="tel" name="phoneno" id="phoneno" class="form-control <?php $__errorArgs = ['phoneno'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($customer->phoneno ?? old('phoneno')); ?>" maxlength="10" placeholder="<?php echo e(__('Enter customer phone#')); ?>">
...
</div><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/customers/formgroup.blade.php ENDPATH**/ ?>