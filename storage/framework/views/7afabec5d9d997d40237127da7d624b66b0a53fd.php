                    ...
                    <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;">
                        <div class="simplebar-content" style="padding: 0px;">
                            ...
                            <ul class="navbar-nav flex-column" id="sideNavbar">
                                ...
                                <!-- Nav item -->
                                <li class="nav-item">
                                    <a class="nav-link has-arrow " href="<?php echo e(route('appointments.index')); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sidebar nav-icon me-2 icon-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="3" x2="9" y2="21"></line></svg> <?php echo e(__('Appointments')); ?>
...
<!-- Sidebar end --><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/layouts/partials/side_navbar.blade.php ENDPATH**/ ?>