...
<div class="mb-3 col-md-6 col-6">
    ...
    <input type="text" name="quantity" id="quantity" class="form-control" value="<?php echo e($job->quantity ?? old('quantity')); ?>" placeholder="<?php echo e(__('Enter default quantity')); ?>">
</div>
<div class="mb-3 col-md-6 col-6">
    ...
    <div class="input-group has-validation">
        ...
        <input type="text" name="rate"  aria-describedby="inputGroupPrepend" value="<?php echo e($job->rate ?? old('rate')); ?>" id="rate" class="form-control" placeholder="<?php echo e(__('Enter default rate')); ?>">
    </div>
</div>
...
</div><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/jobs/formgroup.blade.php ENDPATH**/ ?>