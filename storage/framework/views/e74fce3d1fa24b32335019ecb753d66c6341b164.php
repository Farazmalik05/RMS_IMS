<!-- Form group -->
<div class="row"> <?php //justify-content-end ?>
    <div class="col-lg-4 col-md-6 col-12 mb-3">
        <label class="form-label" for="date"><?php echo e(__('Date')); ?> <span class="text-danger">*</span></label>
        <div class="input-group me-3 flatpickr rounded flatpickr-input active" readonly="readonly">
            <input id="date" name="date" class="form-control flatpickr flatpickr-input" placeholder="" type="text" placeholder="<?php echo e(__('Enter imvoice date')); ?>" aria-describedby="date">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('phoneno')); ?>" placeholder="<?php echo e(__('Enter customer phone#')); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-12 mb-3">
        <label class="form-label" for="details"><?php echo e(__('Repair details')); ?></label>
...
</div><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/jobcards/formgroup.blade.php ENDPATH**/ ?>