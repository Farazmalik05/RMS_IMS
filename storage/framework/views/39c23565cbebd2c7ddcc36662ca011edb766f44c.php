...
<div class="row">
    <div class="col-lg-12 col-md-12 col-12">
        <!-- Page header -->
        <div class="mb-4">
            <h3 class="mb-0 "><?php echo e(__('Descriptions')); ?></h3>
        </div>
    </div>
</div>
<div>
            ...
            <div class="card">
                <div class="card-header d-lg-flex justify-content-between ">
                    <div class="d-grid d-lg-block">
                        <a href="<?php echo e(route('descriptions.create')); ?>" class="btn btn-primary" id="new-job">
                            <?php echo e(__('+ Create New Description')); ?>
                                ...
                                <tbody class="list contact-list-container">
                                    <?php $__currentLoopData = $descriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="name td"><?php echo e($description->job->name); ?></td>
                                            <td class="phone td"><?php echo e($description->description); ?></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="<?php echo e(route('descriptions.edit', $description)); ?>" class="btn btn-ghost btn-icon btn-sm rounded-circle">
                                                    ...
                                                    <form id="delete-description-<?php echo e($description->id); ?>" action="<?php echo e(route('descriptions.destroy', $description)); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\RMS_IMS\resources\views/descriptions/index.blade.php ENDPATH**/ ?>