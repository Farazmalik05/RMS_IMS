                                    ...
                                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr title="<?php echo e($jobs); ?>">
                                            ...
                                            <?php if($invoice->taxable): ?>
                                                <td class="total td">$<?php echo e(number_format((float)$invoice->jobs->sum('pivot.rate') * (1 + 10/100), 2, '.', '')); ?></td>
                                            <?php else: ?>
                                                <td class="total td">$<?php echo e(number_format((float)$invoice->jobs->sum('pivot.rate'), 2, '.', '')); ?></td>
                                            <?php endif; ?>
                                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\RMS_IMS\resources\views/invoices/index.blade.php ENDPATH**/ ?>