...
<div class="mb-3 col-md-4 col-4">
    ...
    <select name="state" id="state" class="form-select">
        ...
        <option value="VIC" <?php if(isset($customer->state)): ?> <?php if($customer->state == 'VIC'): ?> selected <?php endif; ?> <?php endif; ?>> VIC </option>
...
<div class="mb-3 col-md-4 col-4">
    <label class="form-label" for="comments"><?php echo e(__('Comments')); ?></label>
    <input type="text" name="comments" id="comments" value="<?php echo e($customer->comments ?? old('comments')); ?>" class="form-control" placeholder="<?php echo e(__('Enter comments')); ?>">
</div>
<div class="mb-3 col-md-4 col-4">
...
</div><?php /**PATH D:\wamp\www\RMS_IMS\resources\views/customers/formgroup.blade.php ENDPATH**/ ?>