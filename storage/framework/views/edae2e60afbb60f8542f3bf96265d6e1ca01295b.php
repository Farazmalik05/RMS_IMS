            ...
            <div class="row gy-3">
                <div class="col-sm-3">
                    ...
                    <?php if(!empty($invoice->vehicle->customer->company_name)): ?>
                        <p><?php echo e(ucfirst($invoice->vehicle->customer->company_name)); ?></p>
                    <?php endif; ?>
                </div>
                <div class="col-sm-3">
...
</html><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/invoices/generate-invoice.blade.php ENDPATH**/ ?>