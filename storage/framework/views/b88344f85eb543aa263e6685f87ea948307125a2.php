            ...
            <table id="quote_table" class="table text-nowrap table-bordered">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input class="form-control input amount" value="0.00" name="amtdue" id="amtdue">
                        </td>
                    </tr>
                </tfoot>
            </table>
...
</div><?php /**PATH /home/rmsautoa/public_html/IMS/resources/views/quotes/formgroup.blade.php ENDPATH**/ ?>