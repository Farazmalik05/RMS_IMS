...
<div class="row justify-content-between mb-md-10">
    ...
    <div class="col-xxl-3 col-lg-6 col-md-6 col-12 mt-4 mt-md-0">
        <div class="row align-items-center mb-2">
            <div class="col-md-5">
                <label class="form-label" for="quote_number"><?php echo e(__('Invoice#')); ?> <span class="text-danger">*</span></label>
            </div>
            <div class="col-md-7">
                <div class="input-group has-validation">
                    <span id="quote_year" name="quote_year" class="input-group-text" id="inputGroupPrepend" style="border-bottom-right-radius:0px;border-top-right-radius:0px;">INV/RMS/<?php echo e(date('Y', strtotime($invoice->quote_date))); ?>/</span>
                    <input type="text" disabled name="quote_number"  aria-describedby="inputGroupPrepend" value="<?php echo e(sprintf('%02d', $invoice->quote_number)); ?>" id="invoice_number" class="form-control" placeholder="<?php echo e(__('Enter Invoice#')); ?>">
                </div>
            </div>
        </div>
        <div class="row align-items-center mb-2">
...
<div class="row mb-md-10">
    <div class="col-xxl-3 col-lg-4 col-md-6 col-12 mb-3">
        <label class="form-label" for="customer_name"><?php echo e(__('Name')); ?> <span class="text-danger">*</span></label>
            <input type="text" disabled="disabled" name="customer_name" id="customer_name" class="form-control" value="<?php echo e($invoice->vehicle->customer->name); ?>">
...
<div class="row">
    <div class="col-xxl-3 col-lg-6 col-md-6 col-12 mb-3">
        ...
        <textarea name="remarks" id="remarks" class="form-control" rows="3" placeholder="<?php echo e(__('Enter remarks')); ?>"><?php echo e($invoice->remarks); ?></textarea>
    </div>
    <div class="col-xxl-3 col-lg-6 col-md-6 col-12 mb-3">
    ...
    <div class="col-xxl-3 col-lg-6 col-md-6 col-12 mb-3">
        <div class="row">
            <div class="col-xxl-3 col-lg-12 col-md-12 col-12 mb-3">
                ...
                <input type="text" name="tire_fl" id="tire_fl" class="form-control" value="<?php echo e($invoice->tire_fl); ?>" placeholder="<?php echo e(__('Enter front left tyre mm')); ?>">
            </div>
            <div class="col-xxl-3 col-lg-12 col-md-12 col-12 mb-3">
                <label class="form-label" for="tire_fr"><?php echo e(__('Tyre front right')); ?></label>
                <input type="text" name="tire_fr" id="tire_fr" class="form-control" value="<?php echo e($invoice->tire_fr); ?>" placeholder="<?php echo e(__('Enter front right tyre mm')); ?>">
            </div>
            <div class="col-xxl-3 col-lg-12 col-md-12 col-12 mb-3">
                <label class="form-label" for="tire_rl"><?php echo e(__('Tyre rear left')); ?></label>
                <input type="text" name="tire_rl" id="tire_rl" class="form-control" value="<?php echo e($invoice->tire_rl); ?>" placeholder="<?php echo e(__('Enter rear left tyre mm')); ?>">
            </div>
            <div class="col-xxl-3 col-lg-12 col-md-12 col-12 mb-3">
                <label class="form-label" for="tire_rr"><?php echo e(__('Tyre rear right')); ?></label>
                <input type="text" name="tire_rr" value="<?php echo e($invoice->tire_rr); ?>" id="tire_rr" class="form-control" placeholder="<?php echo e(__('Enter rear right tyre mm')); ?>">
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-lg-6 col-md-6 col-12 mb-3">
...
<?php /**PATH D:\wamp\www\RMS_IMS\resources\views/invoices/editformgroup.blade.php ENDPATH**/ ?>