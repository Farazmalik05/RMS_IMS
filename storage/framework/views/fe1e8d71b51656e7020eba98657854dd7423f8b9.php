        ...
        <div class="table-responsive">
            <table id="quote_table" class="table text-nowrap table-bordered">
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="3" class="border-bottom-0" style="text-align:right;">
                            <strong><?php echo e(__('Amount Paid')); ?> ($):</strong>
                        </td>
                        <td colspan="2">
                            <?php
                                $amtpaid = $total - $quote->amtdue;
                            ?>
                            <input class="form-control input" value="<?php echo e(number_format((float)$amtpaid, 2, '.', '')); ?>" name="amtpaid" id="amtpaid">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" class="border-bottom-0" style="text-align:right;">
                            <strong><?php echo e(__('Amount Due')); ?> ($):</strong>
                        </td>
                        <td colspan="2" class="text-left">
                            <input class="form-control input" value="<?php echo e(number_format((float)$quote->amtdue, 2, '.', '')); ?>" name="amtdue" id="amtdue" readonly>
                        </td>
                    </tr>
                </tfoot>
            </table>
...
</div><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/quotes/editformgroup.blade.php ENDPATH**/ ?>