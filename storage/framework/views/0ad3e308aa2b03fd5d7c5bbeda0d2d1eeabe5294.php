        ...
        <div class="row align-items-center mb-2">
            ...
            <div class="col-md-7">
                <div class="input-group has-validation">
                    <span id="quote_year" name="quote_year" class="input-group-text" id="inputGroupPrepend" style="border-bottom-right-radius:0px;border-top-right-radius:0px;">Quote/RMS/2023/</span>
            ...
            <table id="quote_table" class="table text-nowrap table-bordered">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td colspan="2">$ <span class="text-dark" id="sub_total">0.00</span></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="border-bottom-0"></td>
                        <td><span class="text-dark">Tax*</span></td>
                        <td colspan="2"><span class="text-dark" id="tax">10</span>%</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="border-bottom-0"></td>
                        <td><span class="text-dark fw-bold">Total paid</span></td>
                        <td colspan="2"><span class="text-dark fw-bold">$</span> <span class="text-dark fw-bold" id="total">0.00</span></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<?php /**PATH D:\wamp\www\RMS_IMS\resources\views/quotes/formgroup.blade.php ENDPATH**/ ?>