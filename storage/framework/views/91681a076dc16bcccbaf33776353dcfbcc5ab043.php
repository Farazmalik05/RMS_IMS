        ...
        $(document).ready(function(){
            function config_details(check_val) {
                if($(check_val).val() == 'groupon') {
                    ...
                    $('#repair_details').css('display','none');
                    ...
                    $('#repair_details').css('display','block');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rmsautoa/public_html/IMS/resources/views/jobcards/create.blade.php ENDPATH**/ ?>