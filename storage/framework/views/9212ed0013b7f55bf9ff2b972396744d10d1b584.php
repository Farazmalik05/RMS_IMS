                                ...
                                <tbody class="list contact-list-container">
                                    <?php $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr title="<?php echo e($jobs); ?>">
                                            ...
                                            <td class="total td">$<?php echo e(number_format((float)$quote->total, 2, '.', '')); ?></td>
                                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/rmsauto5/public_html/IMS/resources/views/quotes/index.blade.php ENDPATH**/ ?>