...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <!-- Favicon icon-->
        <link rel="shortcut icon" type="<?php echo e(asset('images/favicon/icons8-invoice-pastel-32.png')); ?>" href="">
        ...
        <title>RMS | Invoice Management System'</title>
    </head>
    <body>
...
</html><?php /**PATH D:\wamp\www\RMS_IMS\resources\views/layouts/app.blade.php ENDPATH**/ ?>