...
<div class="row">
    <div class="col-lg-12 col-md-12 col-12">
        <!-- Page header -->
        <div class="mb-4">
            <h3 class="mb-0 "><?php echo e(__('Add Quote')); ?></h3>
        </div>
    </div>
</div>
<div>
    ...
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route('quotes.store')); ?>" method="Post" id="quote-form">
                <?php echo csrf_field(); ?>
                <div class="card">                
                    <div class="card-body">                        
                        <?php echo $__env->make('quotes.formgroup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="row">
        ...
        $(document).ready(function(){
            ...
            $( "#rego" ).autocomplete({
                ...
                select: function( event, ui ) {
                    ...
                    var message = '<p>' + ui.item.customer.warn + '</p>'
                    $("#customerwarning_modalbody").html(message);
                    $("#customerwarningModal").modal('toggle');
                    return false;
                }
            ...
            $("#quote-form").on('submit', function(e){
                ...
                $.ajax({
                    ...
                    beforeSend: function(){
                        ...
                        $('#quote-save').text("<?php echo e(__('Saving...')); ?>");
                    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\RMS_IMS\resources\views/quotes/create.blade.php ENDPATH**/ ?>