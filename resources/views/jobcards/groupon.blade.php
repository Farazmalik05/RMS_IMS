        ...
        <table id="info" style="width:100%;margin-bottom:7px;">
            <tr>
                ...
                <td style="border-left:none;position:relative;">
                    ...
                    <div style="padding-left:150px;">Voucher code: {{ $vehicle['voucher_code'] }}</div>
                </td>
            </tr>
        </table>
        ...
        <table class="job-details">
            ...
            <tr>
                ...
                <td style="position:relative;text-align:left;padding:3px;">
                    <span style="padding-left:3px;">@if(isset($vehicle['is_logbook']) && $vehicle['is_logbook'] == 1) Carryout minor engine service, Groupon $89 / $110, Log book. @else Carryout minor engine service, Groupon $89 / $110. @endif</span>
                </td>
