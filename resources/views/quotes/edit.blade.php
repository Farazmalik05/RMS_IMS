    ...
    <script>
        $(document).ready(function(){
            ...
            $("#quote_date").flatpickr({
                dateFormat: "d-m-Y",
                defaultDate: "{{  date('d-m-Y', strtotime($quote->quote_date)) }}",
            });

            $("#quote_duedate").flatpickr({
                dateFormat: "d-m-Y",
                defaultDate: "{{  date('d-m-Y', strtotime($quote->quote_duedate)) }}",
            });

            $("#nextservicedate").flatpickr({
                dateFormat: "d-m-Y",
                defaultDate: "{{  date('d-m-Y', strtotime($quote->nextservicedate)) }}",
            });
